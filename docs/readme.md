...
Every push to `main` runs the same deploy via GitHub Actions. See [github-actions.md](github-actions.md) for CI secrets, DNS, GitHub Pages, and how to recover credentials.
